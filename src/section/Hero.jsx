...
import cadeau from "../assets/cadeau.jpg"; // Replace with the resized image file path
    ...
    <main id="home" className="flex items-center h-[95vh] gap-6 px-5 bg-gray-900 w-full text-white z-0">
      ...
      <div className="w-1/3 flex justify-center items-center">
        <img
          src={cadeau}
          alt="profile"
          className="w-[300px] h-[300px] object-cover rounded-full shadow-lg border-4 border-cyan-500"
        />
      </div>
    </main>
  );
